...
import { BsNewspaper, BsPerson, BsTable } from "react-icons/bs";
        ...
        <GridItem w="100%" h="60">
          <Link to="/admin/candidate">
            <Card
              ...
              _hover={{ bg: "blue.700" }}
            >
              <BsPerson size={70} color={Colors.LIGHT_WHITE} />
              <Text
                fontWeight={"bold"}
                fontSize="28"
                color={Colors.LIGHT_WHITE}
        ...
        <GridItem w="100%" h="60">
          <Link to="/admin/participation">
            <Card
              ...
              _hover={{ bg: "blue.700" }}
            >
              <BsTable size={70} color={Colors.LIGHT_WHITE} />
              <Text
                fontWeight={"bold"}
                fontSize="28"
                color={Colors.LIGHT_WHITE}
              ...
              <Text color={Colors.DARK3}>Result | Submition</Text>
            </Card>
          </Link>
        </GridItem>
      </Grid>
