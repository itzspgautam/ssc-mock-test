    ...
    >
      ...
      <GridItem area={"body"}>
        <Flex h="full" flexDir="column" justifyContent={"flex-start"}>
          ...
          <Box height={"65vh"} overflowY={"scroll"} px="10" py="5">
          ...
          >
            <Box w="80%">
              ...
              <Checkbox defaultChecked>
                <Text fontSize={12}>
                  {insLang === "hindi"
                    ? "मैं निर्देश पढ़ लया है और समझ लिया है। मुझे आवंटित किए गए सभी कंप्यूटर हार्डवेयर उचित कार्यशील स्थिति में हैं। मैं घोषणा करता / करती हूं कि मैं मोबाइल फोन, ब्लूटूथ डिवाइस आदि जैसे किसी प्रतिबंधित मोबाइल गैजेट को नहीं पहनने / न रखने / परीक्षा हॉल में मेरे साथ कोई निषिद्ध सामग्री नहीं ले रहा हूं। मैं मानता हूं कि निर्देशों का पालन न करने के मामले में, मैं इस टेस्ट और / या अनुशासनात्मक कार्यवाही से वंचित होने के लिए उत्तरदायी होगा, जिसमें भावी टेस्ट / परीक्षाओं से प्रतिबंध शामिल हो सकता है।"
                    : insLang === "english"
      ...
      <GridItem area={"user"}>
        <Flex justifyContent={"center"} p="8">
          <Image src={Images.DEFAULT_AVATAR} />
        </Flex>
      </GridItem>
